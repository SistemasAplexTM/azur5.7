            ...
            <div class="col-lg-5">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group" :class="{ 'has-error': errors.has('nit') }">
                                    ...
                                    <div class="col-sm-7">
                                        <input v-model="nit" name="nit" placeholder="Nit" class="form-control"
                                            type="text">
                                ...
                                <div class="form-group" :class="{ 'has-error': errors.has('name') }">
                                    ...
                                    <div class="col-sm-7">
                                        <input v-model="name" name="name" placeholder="Nombre" class="form-control"
                                            type="text" v-validate.disable="'required'" />
                        ...
                        {{-- Si existe una imagen entocnes mostrarla --}}
                        <div class="row" v-if="sourceLogo">
                            <div class="col-lg-12">
                                <img :src="sourceLogo" alt="Logo" class="img-responsive" style="width: 300px;float: inline-end;">
                            </div>
                        </div>
