...
<style type="text/css">
  ...
  .ibox-tools a.btn-success{
    ...
    <div class="row" id="minuta">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                      <a class="btn btn-success" title="Excel proveedores" data-toggle="modal" data-target="#modalProveedor" id="excel"><i class="fa fa-file-excel-o"></i> Excel Proveedores</a>
      		            ...
      		            <div class="modal-body">
      		            	<form id="formMinuta" enctype="multipart/form-data" class="form-horizontal" role="form" autocomplete="off">
                                ...
                                <div class="form-group" :class="{ 'has-error': errors.has('tipo_us_id') }">
                                  ...
                                  <el-select v-model="tipo_us_id" name="tipo_us_id" placeholder="Tipo UDS" value-key="id" v-validate.disable="'required'">
                                    <el-option
                                ...
                                <div class="form-group" :class="{ 'has-error': errors.has('cliente_id') }">
                                  ...
                                  <el-select v-model="cliente_id" name="cliente_id" placeholder="Cliente" value-key="id" v-validate.disable="'required'">
                                    <el-option
                                ...
                                <div class="form-group" :class="{ 'has-error': errors.has('us_id') }">
                                  ...
                                  <el-select v-model="us_id" name="us_id" placeholder="Unidades de servicio" :disabled="disabled_us" multiple value-key="id" v-validate.disable="'required'">
                                    <el-option
                                ...
                                <div class="form-group" :class="{ 'has-error': errors.has('menu_id') }">
                                  ...
                                  <el-select v-model="menu_id" name="menu_id" placeholder="Menus" :disabled="disabled_menu" multiple multiple-limit="5" value-key="id" v-validate.disable="'required'">
                                    <el-option
                                      v-for="item in menus"
                                      :key="item.id"
                                      :label="item.name"
      ...
      <!-- modal imprimir proveedores por tipo de producto -->
  	    <div class="modal fade bs-example" id="modalProveedor" tabindex="" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  		    <div class="modal-dialog">
  		        <div class="modal-content">
  		            <div class="modal-header">
  		                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
  		                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-tasks"></i> Imprimir pedido para proveedores</h4>
  		            </div>
  		            <div class="modal-body">
  		            	<form id="formPrint" enctype="multipart/form-data" class="form-horizontal" role="form" autocomplete="off">
  			                <div class="row">
                              ...
                              <div class="form-group">
                                  <label for="produc_type_id" class="control-label gcore-label-top">Tipo de proucto:</label>
                                  <el-select v-model="produc_type_prov_id" filterable placeholder="Tipos de producto" @change="searchProvider">
                                    <el-option
                                      v-for="item in produc_types"
                                      :key="item.id"
                                      :label="item.name"
                                      :value="item.id">
                                    </el-option>
  		                    	...
  		                    	<div class="col-lg-6">
                              <div class="form-group">
                                  <label for="produc_type_id" class="control-label gcore-label-top">Proveedor:</label>
                                  <el-select v-model="provider_id" filterable :disabled="(produc_type_prov_id === null) ? true : false" placeholder="Proveedores">
                                    <el-option
  		            ...
  		            <div class="modal-footer">
  		                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
  		                <button type="button" class="btn btn-primary" id="proveedores"><i class="fa fa-download"></i> Descargar Agrupado</button>
  		                <button type="button" class="btn btn-success" id="proveedores1"><i class="fa fa-download"></i> Descargar</button>
  		            </div>
  		        </div>
  		    </div>
  		</div>
